-- Create set_comment_vote RPC function
...
-- Create comments_for_post RPC function
...
BEGIN
    ...
    LEFT JOIN public.comment_votes cv ON c.id = cv.comment_id AND cv.user_id = current_user_id
